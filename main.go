...
func printHelp() {
	...
	fmt.Println("  mig-diff uses the same config files as mig-tree:")
	fmt.Println("  - .mig-tree.yaml (repository-specific)")
	fmt.Println("  - ~/.config/mig-tree/config.yaml (global)")
	fmt.Println()
